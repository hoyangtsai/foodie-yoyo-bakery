...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Root = function (_React$Component) {
	  ...
	  function Root(props) {
	    ...
	    return (0, _possibleConstructorReturn3.default)(this, (Root.__proto__ || (0, _getPrototypeOf2.default)(Root)).call(this, props));
	  }

	  (0, _createClass3.default)(Root, [{
	    key: 'getStripedStyle',
	    value: function getStripedStyle(index) {
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              ...
	              tableData.map(function (row, index) {
	                return _react2.default.createElement(
	                  'tr',
	                  { style: (0, _extends3.default)({}, _this2.getStripedStyle(index)) },
	                  _react2.default.createElement(
	                    'td',
	                    null,
	                    row.name,
	                    ' ',
	                    row.note ? _react2.default.createElement(
	                      'span',
	                      { style: styles.note },
	                      row.note
	                    ) : '',
	        ...
	        _react2.default.createElement('div', { className: 'ingd-img' })
	      );
	    }
	  }]);
	  return Root;
	...
	_reactDom2.default.render(_react2.default.createElement(Root, null), document.querySelector('.wrapper'));
